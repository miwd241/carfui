...
<body>
        ...
        <div class="app-sidebar">
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
          <?php if($user['image'] == 'img.pg')?>
                  <img src="../../public/uplodes/defolt/img.jpg">
                     <?php else : ?>
                <img src="../../public/uplodes/defolt/img.jpg">   
                     <?php endif; ?>
                        ...
                        <span class="user-info-text"><?= $_SESSION['author_name']?>,Your IDis -
                        <?= $_SESSION['author_id']?><br><span class="user-state-info">On a call</span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?= ($link =='home.php')? 'active-page' : ''?>">
                        ...
                        class="active"><i class="material-icons-two-tone">dashboard</i>Dashboard</a>
                    </li>
                    <!--<li>
    ...
    <li  class="<?= ($link =='service.php')? 'active-page' : ''?>">
                        <a href="../service/services.php"><i class="material-icons-two-tone">medical_services</i>services</a>
    </li>
    <!--
                    <li>
...
<                               <a class="nav-link btn btn-danger btm sm text-white " href="../logout/logout.php"><i class="fa-solid fa-right-from-bracket"></i>logout</a>
                                                      </li>
