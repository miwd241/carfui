...
<body>
    ...
    <!--register completa mesg-->


    <?php
 if(isset($_SESSION['register_completa']) && isset($_SESSION['register_name'])) :?>
    <div class="alert alert-custom" role="alert">
                          <div class="custom-alert-icon icon-success"><i class="material-icons-outlined">done</i></div>
                         <div class="alert-content">
                        <span class="alert-title"><?php echo $_SESSION['register_completa']?></span>
     ...
     <?php endif; 
     unset($_SESSION['register_complete']); unset($_SESSION['register_name'])?>

    <!--register completa msg--> 
   
    <form action="manage.php" method="POST">
            <div class="auth-credentials m-b-xxl">
                <label for="signInEmail" class="form-label">Email address</label>
                <input type="text" class="form-control m-b-md" name="email" placeholder="example@neptune.com" 
...
<!----password end---->    
    ...
    <script src=" ckend/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
