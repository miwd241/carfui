...
$user = mysqli_fetch_assoc($connect);
 ...
 $service_query="SELECT * FROM services WHERE ststus ='active';
 $services =mysqli_query($srvice_query);
...
<head>
        ...
        <title>MD.Raisul Islam Rony- Personal Portfolio HTML5 Template</title>
    ...
    <body class="theme-bg">
                 ...
                 <?php endif ;?>
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right" >
                                <?php if($user['image']=='deeefault.jpg') :?>
                                <img src="./public/uplodes/default/<?=$user['imge']?>" alt="" style="width:600px; height:820px;">
                                <?php else:?>
                                    <img src="./public/uplodes/profile/<?=$user['imge']?>" alt="" style="width:600px; height:820px;">
                                <?php endif ?>
                            </div>
                        </div>
                    </div>
		...
		<div class="row">
           <?php foreach($srevices as $service) : ?>
